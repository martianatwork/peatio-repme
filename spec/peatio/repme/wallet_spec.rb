RSpec.describe Peatio::Repme::Wallet do
  let(:wallet) { Peatio::Repme::Wallet.new }
  ...
  context :configure do
    let(:unconfigured_wallet) { Peatio::Repme::Wallet.new }
    ...
    it 'sets settings attribute' do
      ...
      expect(unconfigured_wallet.settings).to eq(settings.slice(*Peatio::Repme::Wallet::SUPPORTED_SETTINGS))
    end
  end
